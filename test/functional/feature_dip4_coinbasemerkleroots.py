...
class LLMQCoinbaseCommitmentsTest(DiabaseTestFramework):
    ...
    def run_test(self):
        ...
        # Register one more MN, but don't start it (that would fail as DiabaseTestFramework doesn't support this atm)
