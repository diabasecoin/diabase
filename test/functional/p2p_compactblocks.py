...
# TestP2PConn: A peer we use to send messages to diabased, and store responses.
...
class CompactBlocksTest(BitcoinTestFramework):
    ...
    # This test actually causes diabased to (reasonably!) disconnect us, so do this last.
    ...
    # Test that diabased requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for diabased to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # diabased will not send blocktxn responses for blocks whose height is
