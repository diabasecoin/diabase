...
official/supported Docker Images found at https://hub.docker.com/r/diabasecoin/dashd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/diabasecoin/dashd-develop/ when changing the above text**