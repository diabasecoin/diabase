...
and outputs, they are most useful for financial transactions (i.e. transfers of quantities of Diabase
...
The introduction of special transactions will require the whole Diabase ecosystem to perform a one-time
...
entry to that masternode list after the owner created a 1000 Diabase UTXO and the masternode broadcast
...
transaction which includes either a 1000-Diabase collateral payment or a reference to it, along with
...
-------------------------------------------------------------------
A verifiable and correct masternode list is foundational to many Diabase features, including verification
...
mixing denom (0.00100001 DIAC) now while keeping all the old ones too. It also makes sense to allow more
...
- [`1681d6366`](https://github.com/dashpay/dash/commit/1681d6366) Replace Diabase-specific threads with Diabase-specific scheduled tasks (#2043)
...
- [`e23339d6f`](https://github.com/dashpay/dash/commit/e23339d6f) use nullptr in Diabase-specific code (#2166)
...
- [`8ee9333bc`](https://github.com/dashpay/dash/commit/8ee9333bc) remove boost dependency from Diabase-specific code (#2072)
