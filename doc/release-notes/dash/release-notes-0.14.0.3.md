...
--------------------------------
Version 0.13.0.0 introduced a new database (evodb) which is found in the datadir of Diabase Core. It turned
...
Version 0.14.0.0 also introduced a new database (llmq) which is also found in the datadir of Diabase Core.
...
---------------------------------------------------
AppNap is disabled now when Diabase Core is syncing/reindexing or mixing.
...
--------------------------------------------------
The debug console will now show how many InstantSend locks Diabase Core knows about. Please note that this number
...
- [`5af6ce91d`](https://github.com/dashpay/dash/commit/5af6ce91d) Add Diabase Core Group codesign certificate (#3027)
