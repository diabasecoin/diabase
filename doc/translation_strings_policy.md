...
This document provides guidelines for internationalization of the Diabase Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `diabase_en.ts` remains unchanged.
