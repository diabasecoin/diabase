...
* diabase.conf: contains configuration settings for diabased or diabase-qt
* diabased.pid: stores the process id of diabased while running
...
* debug.log: contains debug information and general logging generated by diabased or diabase-qt
