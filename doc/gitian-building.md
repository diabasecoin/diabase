...
cd /some/root/path/
git clone https://github.com/dashpay/dash-sigs.git
...
[diabase/gitian.sigs](https://github.com/dashpay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
