...
This mechanism has been integrated into Bitcore-Node-Diabase which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/diabasecoin/insight-api-diabase#web-socket-api](https://github.com/diabasecoin/insight-api-diabase#web-socket-api)
* API: [https://github.com/diabasecoin/insight-api-diabase#instantsend-transactions](https://github.com/diabasecoin/insight-api-diabase#instantsend-transactions)
