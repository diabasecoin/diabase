...
- Detached signatures will then be committed to the [diabase-detached-sigs](https://github.com/dashpay/dash-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Release on Diabase forum: https://www.diabase.org/forum/topic/official-announcements.54/
