...
<context>
    ...
    <message>
        ...
        <translation>Это ваши адреса Diabase для отправки платежей. Всегда проверяйте количество и адрес получателя перед отправкой перевода.</translation>
    </message>
    <message>
        ...
        <translation>Это ваши адреса Diabase для приёма платежей. Рекомендуется использовать новый адрес получения для каждой транзакции.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: если Вы зашифруете кошелёк и потеряете пароль, вы &lt;b&gt;ПОТЕРЯЕТЕ ВСЕ ВАШИ DIAC&lt;/b&gt;!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Произошла критическая ошибка. Дальнейшая безопасная работа Diabase Core невозможна, программа будет закрыта.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отправить монеты на указанный адрес Diabase</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Запросить платежи (создать QR-коды и diabase: URI)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Показать информацию о Diabase Core</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Отправить %1 средства на Diabase адрес</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подписать сообщения вашими адресами Diabase, чтобы доказать, что вы ими владеете</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Проверить сообщения, чтобы удостовериться, что они были подписаны определёнными адресами Diabase</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Открыть diabase: URI или запрос платежа</translation>
    </message>
    <message>
    ...
    <message numerus="yes">
        ...
        <translation><numerusform>%n активное соединение с сетью Diabase</numerusform><numerusform>%n активных соединения с сетью Diabase</numerusform><numerusform>%n активных соединений с сетью Diabase</numerusform><numerusform>%n активных соединений с сетью Diabase</numerusform></translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введённый адрес "%1" не является правильным адресом Diabase.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>%1 скачает и сохранит копию цепочки блоков Diabase.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Последние транзакции пока что могут быть не видны и поэтому ваш баланс может отображаться некорректно. Информация будет корректироваться по мере синхронизации с сетью Diabase, подробности о ходе синхронизации представлены ниже.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для Diabase Core на роутере. Работает только в том случае, если Ваш роутер поддерживает UPnP и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Diabase через прокси SOCKS5.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Подключаться к сети Diabase через отдельный прокси SOCKS5 для скрытых сервисов Tor.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Отображаемая информация может быть устаревшей. Ваш кошелёк автоматически синхронизируется с сетью Diabase после подключения, но этот процесс пока не завершён.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>0 DIAC / 0 раундов</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Не удаётся запустить обработчик diabase: click-to-pay</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>'diabase://' не является валидным URI. Используйте 'diabase:'.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Не удалось разобрать URI! Возможно указан некорректный адрес Diabase либо параметры URI сформированы неверно.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введите адрес Diabase (например, %1)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса. Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть Diabase.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Необязательное сообщение для запроса платежа, которое будет показано при открытии запроса.&lt;br&gt;Обратите внимание: сообщение не будет отправлено вместе с платежом через сеть Diabase.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Внимание: неверный адрес Diabase</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Адрес Diabase для отправки на него монет</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссия будет вычтена из отправляемой суммы. Получателю придет меньше Diabase, сем указано в поле "Сумма". Если указано несколько получателей, то комиссия будет разделена между ними поровну.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>К diabase: URI было прикреплено сообщение, которое будет сохранено вместе с транзакцией для вашего сведения. Обратите внимание: сообщение не будет отправлено через сеть Diabase.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вы можете подписывать сообщения своими адресами, чтобы доказать, что Вы можете получать Diabase на них. Будьте осторожны, не подписывайте что-то неопределённое, так как фишинговые атаки могут обманным путём заставить вас подписать нежелательные сообщения. Подписывайте только те сообщения, с которыми вы согласны вплоть до мелочей.</translation>
    </message>
    <message>
        <source>The Diabase address to sign the message with</source>
        <translation>Адрес Diabase, которым Вы хотите подписать сообщение</translation>
    </message>
    <message>
        <source>Choose previously used address</source>
        <translation>Выбрать ранее использованный адрес</translation>
    ...
    <message>
        ...
        <translation>Подписать сообщение, чтобы доказать владение этим адресом Diabase</translation>
    </message>
    <message>
        <source>Sign &amp;Message</source>
        <translation>Подписать &amp;сообщение</translation>
    ...
    <message>
        ...
        <translation>Адрес Diabase, которым было подписано сообщение</translation>
    </message>
    <message>
        <source>Verify the message to ensure it was signed with the specified Diabase address</source>
        <translation>Проверить сообщение, чтобы убедиться, что оно было подписано указанным адресом Diabase</translation>
    </message>
    <message>
        <source>Verify &amp;Message</source>
        <translation>Проверить &amp;сообщение</translation>
