...
//! Interface for the src/evo part of a diabase node (dashd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a diabase node (dashd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a diabase node (dashd process).
...
//! Top-level interface for a diabase node (dashd process).
class Node
{
public:
    virtual ~Node() {}
