...
//! Interface for the src/evo part of a diabase node (diabased process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a diabase node (diabased process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a diabase node (diabased process).
...
//! Top-level interface for a diabase node (diabased process).
class Node
{
public:
    virtual ~Node() {}
