...
{
    const char* pszTimestamp = "July 5th 2023, Diabase coin is born";
    const CScript genesisOutputScript = CScript() << ParseHex("04c5901755e719af3cb8fa5a2d0fb481fcf0ee4ef8d1c4b1c6528ebf971accc5abb1ebb9b8953f8381cc073431662b8b70a51e3f72eeb4365bd0e55372f17fa16b") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nMasternodePaymentsIncreaseBlock = 2100000000;  // Disabled
        consensus.nMasternodePaymentsIncreasePeriod = 2100000000; // Disabled
        ...
        consensus.nSuperblockStartHash = uint256S("0x0000057be3e5420fcefa43eda26de60a3802bfc55a967443b07a41c133e0008f");
        ...
        consensus.DIP0003EnforcementHash = uint256S("0x0000057be3e5420fcefa43eda26de60a3802bfc55a967443b07a41c133e0008f");
        consensus.DIP0008Height = 0;
        ...
        consensus.nPowKGWHeight = 175200;
        consensus.nPowDGWHeight = 350400;
...
//        consensus.nMinimumChainWork = uint256S("0x00000000000000000000000000000000000000000000549cd3ccb81a55892330"); // 1450000
        ...
        consensus.defaultAssumeValid = uint256S("0x0000057be3e5420fcefa43eda26de60a3802bfc55a967443b07a41c133e0008f"); // genesis
        ...
        genesis = CreateGenesisBlock(168892927, 1810909, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000057be3e5420fcefa43eda26de60a3802bfc55a967443b07a41c133e0008f"));
        assert(genesis.hashMerkleRoot == uint256S("0x7e49b140f6ed27adab6197c6b69608972ebe758eb409c00ecf79e3f8fae82a07"));
        ...
        // Diabase script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Diabase private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // Diabase BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Diabase BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // Diabase BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"XgZ2wKkJiW2P4Fv2bxBsYsgMNb7LeMLgNM"};
        nMinSporkKeys = 1;
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1688928627UL, 1447240UL, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x000008fae8d6978a836cc67f3531dcf4ba3345ef99badd74f92d5c08a0c41a17"));
        assert(genesis.hashMerkleRoot == uint256S("0x7e49b140f6ed27adab6197c6b69608972ebe758eb409c00ecf79e3f8fae82a07"));
        ...
        // Testnet Diabase addresses start with 's'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Diabase script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Diabase BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Diabase BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Diabase BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
        ...
        vSporkAddresses = {"yWgmju5iaT1Pna6cxdPm8wMnX3wCuKaQip"};
 //       vSporkAddresses = {"yjPtiKh2uwk3bDutTEA2q9mCtXyiZRWn55"};
        ...
        checkpointData = {
            {
                {0, uint256S("0x000008fae8d6978a836cc67f3531dcf4ba3345ef99badd74f92d5c08a0c41a17")},
        ...
        chainTxData = ChainTxData{
            1688928627, // * UNIX timestamp of last known number of transactions (Block 477483)
            0,    // * total number of transactions between genesis and that timestamp
                        //   (the tx=... number in the SetBestChain debug.log lines)
            0.0        // * estimated number of transactions per second after that timestamp
        };
...
public:
    CDevNetParams(bool fHelpOnly = false) {
        ...
        genesis = CreateGenesisBlock(1688927627, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6bbe5b651874b79dac4cf3d92b03b4d9e9a0039fa0a7d7ec396cf967740fd7ab"));
        assert(genesis.hashMerkleRoot == uint256S("0x7e49b140f6ed27adab6197c6b69608972ebe758eb409c00ecf79e3f8fae82a07"));
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("diabaseevo.org",  "devnet-seed.diabaseevo.org"));

        // Testnet Diabase addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Diabase script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        ...
        vSporkAddresses = {"yRkjudWhyjwHvGYfe2NYDbHqbtsrPNW3ML"};
 //       vSporkAddresses = {"yjPtiKh2uwk3bDutTEA2q9mCtXyiZRWn55"};
        nMinSporkKeys = 1;
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x6bbe5b651874b79dac4cf3d92b03b4d9e9a0039fa0a7d7ec396cf967740fd7ab")},
...
public:
    CRegTestParams() {
        ...
        vSporkAddresses = {"yfezzUo38Ayyga8SmNVRoFe4YNT8hQAr1L"};
       // vSporkAddresses = {"yj949n1UH6fDhw6HtVE5VMj2iSTaSWBMcW"};
        ...
        // Regtest Diabase addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Diabase script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Diabase BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Diabase BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Diabase BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
